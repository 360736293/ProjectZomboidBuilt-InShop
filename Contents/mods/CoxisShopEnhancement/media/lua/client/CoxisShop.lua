...
CoxisShop.InitPlayer = function()
	...
	if CoxisShop.playerDeathCountTemp[playerIndex] ~= nil and CoxisShop.playerDeathCountTemp[playerIndex] > 0 then
		...
		-- 刚创建角色的首次初始化
		CoxisShop.modData[playerIndex].playerMoney = CoxisShop.modData[playerIndex].playerMoney or 2000;
	end
...
CoxisShop.LoadSettings = function()
	CoxisShop.settings = CoxisUtil.readINI("CoxisShopEnhancement", "CoxisShopSettings.ini");
end
